...
const featuredProject = {
  ...
  description:
    "The very portfolio you are browsing right now! Built from scratch with a heavy focus on premium UI/UX, Glassmorphism design aesthetics, and fluid layout animations. It serves as my definitive professional presentation card.",
...
const projectsData = [
  {
    name: "Lanches MVC",
    description:
      "A robust web application utilizing the MVC pattern for managing and ordering snacks, with strongly typed backend logic.",
    tags: ["C#", ".NET", "MVC"],
  ...
  },
  {
    name: "Clean Catalog",
    description:
      "An API catalog project implementing Clean Architecture principles to ensure high maintainability and decoupled code.",
  ...
  },
  {
    name: "Go Toolkit",
    description:
      "A collection of reusable tools and standard utilities built in Golang to accelerate concurrent backend development.",
  ...
  },
  {
    ...
    description:
      "A project that explores and demonstrates concepts and challenges of concurrency in Go, using multiple ways of parallel processing.",
  ...
  },
  {
    ...
    description:
      "A frontend application built with Angular that consumes external weather APIs to display real-time climate data.",
  ...
  },
  {
    ...
    description:
      "An enterprise-level dashboard interface for managing and tracking inventory and stock movements.",
  ...
  },
  {
    ...
    description:
      "Advanced frontend project demonstrating deep reactive programming with RxJS and rigorous unit testing using Jest.",
  ...
  },
  {
    ...
    description:
      "A fast, responsive, and state-driven task management application built entirely with modern React.",
  ...
  },
  {
    ...
    description:
      "A classic frontend project consuming the official PokéAPI to list, filter, and display Pokémon data dynamically.",
  ...
  },
  {
    ...
    description:
      "A lightweight and fast RESTful API built natively with Express to handle backend routing and data delivery.",
  ...
  },
  {
    name: "Task Control",
    description:
      "A backend-driven task management system enforcing business rules and efficient data persistence.",
    tags: ["C#", ".NET", "Backend"],
    ...
    >
      <div className="projects-header">
        ...
        <p className="subtitle">
          My open-source work, personal experiments, and repositories
        </p>
      </div>
        ...
        <div className="featured-content">
          ...
          <div className="tech-tags">
            {featuredProject.tags.map((tag) => (
              <span key={tag} className="tag featured-tag">
                {tag}
              </span>
            ))}
          </div>
